@echo off
:: NiviK Control Panel - Windows Enhancer
...
echo.
echo.
echo [90m                                                   Welcome[0m [35m%USERNAME%[0m                                                                                                            
echo.                                                       
echo [90m                                    Date is %date% - Time is %time% [0m                                                                                             
echo.
echo                                                 [37m1.[0m [35m[+][0m [37mOptimizations[0m
echo                                                 [37m2.[0m [35m[+][0m [37mPrivacy[0m
echo                                                 [37m3.[0m [35m[+][0m [37mYour System[0m
echo                                                 [37m4.[0m [35m[+][0m [37mAbout[0m
echo                                                 [37m5.[0m [35m[+][0m [37mClose[0m
echo.
echo [90m                                          NiveK is an open-source tool[0m
echo [90m                                     made to enhance your Windows experience[0m
echo.
echo [90m                                  Github: [0m [35mhttps://github.com/primalwound/NiveK[35m
echo.
echo [90m                                                Credits:[0m [35mPrimal[0m                                    
 
choice /c 12345 /n   
if errorlevel 1 set menubookchoice=optimise
if errorlevel 2 set menubookchoice=privacy
if errorlevel 3 set menubookchoice=system
if errorlevel 4 set menubookchoice=about
if errorlevel 5 set menubookchoice=shutdown
cls
goto %menubookchoice%

:optimise
set prevmenu=optimise
cls
echo.     
echo.                                      
echo [35m                        ::::    :::       :::::::::::    :::     :::       ::::::::::       :::    ::: [0m
...
echo.
echo. 
echo                                                 [37m1.[0m [35m[+][0m [37mDisable Bloatware[0m
echo                                                 [37m2.[0m [35m[+][0m [37mDisable Onedrive[0m
echo                                                 [37m3.[0m [35m[+][0m [37mUninstall Edge[0m
echo                                                 [37m4.[0m [35m[+][0m [37mRemove Meet Now Icon[0m
echo                                                 [37m5.[0m [35m[+][0m [37mUninstall Cortana[0m
echo                                                 [37m6.[0m [35m[+][0m [37mUninstall People App[0m
echo                                                 [37m7.[0m [35m[+][0m [37mRemove Internet Explorer[0m
echo                                                 [37m8.[0m [35m[+][0m [37mRemove Xbox Apps[0m
echo.
echo                                                 [37m9.[0m [35m[+][0m [37mMenu[0m
echo.
echo [90m                                          NiveK is an open-source tool[0m
echo [90m                                     made to enhance your Windows experience[0m
echo.
...
if errorlevel 9 set p=Menu
cls
goto %p%

:privacy
set prevmenu=privacy
cls
echo.     
echo.                                      
echo [35m                        ::::    :::       :::::::::::    :::     :::       ::::::::::       :::    ::: [0m
...
echo [90m                                    Date is %date% - Time is %time% [0m
echo.
::Windows Defender Opens New Menu
echo                                          [37m1.[0m [35m[+][0m [37mDisable Windows Defender[0m 
echo                                          [37m2.[0m [35m[+][0m [37mDisable Automatic Updates[0m
echo                                          [37m3.[0m [35m[+][0m [37mDisable Lock Screen App Notifications[0m
echo                                          [37m4.[0m [35m[+][0m [37mClear History Of Recently Opened Documents[0m 
echo                                          [37m5.[0m [35m[+][0m [37mDisable Online Tips[0m 
echo                                          [37m6.[0m [35m[+][0m [37mClear Browser History[0m
echo                                          [37m7.[0m [35m[+][0m [37mEmpty Recycle Bin[0m
echo                                          [37m8.[0m [35m[+][0m [37mClear All Windows Logs[0m
echo.
echo                                          [37m9.[0m [35m[+][0m [37mMenu[0m
echo.
echo [90m                                  Github: [0m [35mhttps://github.com/primalwound/NiveK[35m
...
echo [90m                                    Date is %date% - Time is %time% [0m
echo.
echo.[90m                                            Device Name[0m [35m%USERDOMAIN%[0m
echo.
echo                                            [37m1.[0m [35m[+][0m [37mView System Info [0m
echo                                            [37m2.[0m [35m[+][0m [37mView All Netstat[0m
echo                                            [37m3.[0m [35m[+][0m [37mView All Devices On Network[0m
echo                                            [37m4.[0m [35m[+][0m [37mOpen Task Manager[0m
echo                                            [37m5.[0m [35m[+][0m [37mOpen Powershell[0m
echo                                            [37m6.[0m [35m[+][0m [37mView File Directory[0m
echo                                            [37m7.[0m [35m[+][0m [37mFile Renamer[0m
echo                                            [37m8.[0m [35m[+][0m [37mShutdown Device[0m
echo.
echo                                            [37m9.[0m [35m[+][0m [37mMenu[0m
echo.
echo [90m                                          NiveK is an open-source tool[0m
...
choice /c 123456789 /n
if errorlevel 1 set p=17
if errorlevel 2 set p=18
if errorlevel 3 set p=19
if errorlevel 4 set p=20
if errorlevel 5 set p=21
if errorlevel 6 set p=22
if errorlevel 7 set p=23
if errorlevel 8 set p=24
if errorlevel 9 set p=Menu
cls
goto %p%
...
echo [90m                                    Date is %date% - Time is %time% [0m
echo.
echo                                              [90m Uninstall[0m [35mBloatware[0m [90mList[0m
echo.
echo                                              [35m[+][0m [37mShazam App[0m
echo                                              [35m[+][0m [37mCandy Crush Saga App[0m
echo                                              [35m[+][0m [37mFlipboard App[0m
echo                                              [35m[+][0m [37mIHeartRadio App[0m
echo                                              [35m[+][0m [37mDuolingo App[0m
echo                                              [35m[+][0m [37mPhotoshop Express App[0m
echo                                              [35m[+][0m [37mPandora App[0m
echo                                              [35m[+][0m [37mEclipse Manager App[0m
echo                                              [35m[+][0m [37mCodewriter App[0m
echo.
echo                                              [35m[+][0m [37mMicrosoft Advertising App[0m
echo                                              [35m[+][0m [37mRemote Desktop App[0m
echo                                              [35m[+][0m [37mNetwork Speed Test App[0m
echo                                              [35m[+][0m [37mMicrosoft To Do App[0m
echo.
echo [90m                                          NiveK is an open-source tool[0m
echo [90m                                     made to enhance your Windows experience[0m
echo.
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mCandy Crush Saga App[0
...
:: ----------------------Flipboard app-----------------------
:: ----------------------------------------------------------
echo --- [35m[+][0m [37mFlipboard App[0
...
:: ---------------------iHeartRadio app----------------------
:: ----------------------------------------------------------
echo [35m[+][0m [37miHeartRadio App[0
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mPhotoshop Express App[0
...
:: -------------------Eclipse Manager app--------------------
:: ----------------------------------------------------------
echo [35m[+][0m [37mEclipse Manager App[0
...
:: ---------------------Code Writer app----------------------
:: ----------------------------------------------------------
echo [35m[+][0m [37mCodewriter App[0
...
:: --------------------Uninstall OneDrive--------------------
:: ----------------------------------------------------------
echo [35m[+][0m [37mUninstall Onedrive[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mRemove OneDrive Leftovers[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mDelete OneDrive Shortcuts[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mDisable Usage Of Onedrive[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mPrevent Automatic OneDrive Install[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mPrevent OneDrive Install For New Usage[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mRemove OneDrive From Explore Menu[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mDelete All Related Services[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mDelete OneDrive From Registry[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mUninstall Edge [Chromium-based][0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mMicrosoft Edge [Legacy] App[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mMicrosoft Edge [Legacy] Dev Tools App[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mDesktop App Web Viewer[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mMicrosoft PPI Projection App[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mAssigned Access Lock App[0m
...
:: --------------------Capture Picker app--------------------
:: ----------------------------------------------------------
echo [35m[+][0m [37mCapture Picker App[0m
...
echo [35m[+][0m [37mCloud Experience Host app (breaks Windows Hello password/PIN sign-in options, and Microsoft cloud/corporate sign in)[0m
...
echo [35m[+][0m [37mContent Delivery Manager[0m
...
:: ----------------------------------------------------------
echo [35m[+][0m [37mRemove Meet Now From Task Bar[0
...
:6
@echo off
:: https://privacy.sexy — v0.11.4 — Tue, 06 Dec 2022 02:58:10 GMT
:: Ensure admin privileges
fltmc >nul 2>&1 || (
    echo Administrator privileges are required.
    PowerShell Start -Verb RunAs '%0' 2> nul || (
...
cls
echo.
echo [35m[+][0m [37mEnter the file path of the file you want to rename, please include the file and the proper file extension.[0m
set /p "filerenamerpath=> "
echo.
echo [35m[+][0m [37mEnter the name you want to rename the file to.[0m
set /p "filerenameinput=> "
ren "%filerenamerpath%" %filerenameinput%
cls
echo.
echo [35m[+][0m [37mFile renamed! Returning to the main menu.[0m
pause
cls
goto mainmenu2
